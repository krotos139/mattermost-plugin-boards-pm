...
import DateComponent, {createDatePropertyFromString} from '../date/date'

const timeZoneOffset = (date: number): number => {
    return new Date(date).getTimezoneOffset() * 60 * 1000
}

export default class DeadlineProperty extends DatePropertyType {
    Editor = DateComponent
    name = 'Deadline'
    type = 'deadline' as PropertyTypeEnum
    displayName = (intl: IntlShape) => intl.formatMessage({id: 'PropertyType.Deadline', defaultMessage: 'Deadline'})
